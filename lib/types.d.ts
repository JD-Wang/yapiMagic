...
export interface ServerConfig {
     ...
     */
    customizeFilter?: (api: Omit<IOutPut, 'reqInterfaceName' | 'resInterfaceName' | 'requestInterface' | 'responseInterface'>, opt: {
 ...
 * 请求配置。
 */
export interface RequestConfig<MockUrl extends string = string, ProdUrl extends string = string, Path extends string = string, DataKey extends string | undefined = undefined> {
    /** 接口 Mock 地址，结尾无 `/` */
    mockUrl: MockUrl;
    /** 接口生产环境地址，结尾无 `/` */
    prodUrl: ProdUrl;
...
export declare type ApiJson = ApiJsonItem[];
